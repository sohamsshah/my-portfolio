          ...
          <div className="text-gray-600">
            ...
            <div className="border-b-2">
              ...
              <ul className="text-xl pb-4">
                <li className="my-2"><span className="underline">Languages</span>: JavaScript, TypeScript, Java, Python, HTML5, CSS3 </li>
                <li className="my-2"><span className="underline">Frameworks and Libraries</span>: React.js, Next, Node, Express, Tensorflow, OpenCV</li>
                <li className="my-2"><span className="underline">Platforms</span>: Git (Github and Gitlab), Heroku, AWS, Google Firebase</li>
                <li className="my-2"><span className="underline">Database</span>: MongoDB, SQL, PostgreSQL</li>
            ...
            <div className="border-b-2">
              ...
              <ul className="text-xl pb-4">
                <li className="my-2"><span><a className="underline" href="https://www.youtube.com/watch?v=bFkSf6g1vms&t=1984s" target="_blank" rel="noreferrer"> PULL REQUEST (Open source Workshop)</a></span><span className="font-500"> @GDSC-GHRCE</span> </li>
                <li className="my-2"><span><a className="underline" href="https://www.youtube.com/watch?t=4112&v=v13fju8L-Q8&feature=youtu.be" target="_blank" rel="noreferrer"> UNBUNDLED: The Future of Frontend Tooling</a></span><span className="font-500"> @ReactNativeBLR</span> </li>
            ...
            <div className="border-b-2">
              ...
              <ul className="text-xl pb-4">
                <li className="my-2"><span><a className="underline" href="https://sohamsshah.hashnode.dev/top-12-tips-on-how-to-excel-at-your-developer-job" target="_blank" rel="noreferrer"> Top 12 Tips on how to excel 🚀at your developer job!</a></span></li>
                <li className="my-2"><span><a className="underline" href="https://sohamsshah.hashnode.dev/know-how-git-works-behind-the-scenes-aa40567082ba" target="_blank" rel="noreferrer"> Know how Git works: Behind the Scenes!🤯</a></span></li>
